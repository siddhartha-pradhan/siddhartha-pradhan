const buildReadme = ({ publicRepos, stars, followers, years, months, days, heroGifPath }) => {
  return `<!-- README Generated via Readme.JS. If you're reading this raw, congrats. You're early. -->
